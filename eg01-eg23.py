...
BASE_SIM = {"simulation": {
    ...
    "facility": [
        ...
        {"name": "MineU235",
         "config": {"Source": {"capacity": 4000000000, "commod": "U235", 
                               "recipe_name": "U235"}},}, 
        {"name": "U238", 
         "config": {"Source": {"capacity": 2000000000, "commod": "U238", 
                               "recipe_name": "Uranium 238"}},}, 
        {"name": "DU",
         "config": {"Source": {"capacity": 2000000000, "commod": "DU", 
                               "recipe_name": "DU"}},}, 
        {"name": "DU2",
         "config": {"Source": {"capacity": 2000000000, "commod": "DU2", 
                               "recipe_name": "DU"}},}, 
        {"name": "LWR Fuel Fab",
         "config": {"FuelfabFacility": {
            "fissle_stream": "U235", 
        ...
        {"name": "LWR Seperation",
         "config": {"ReprocessFacility": {
            ...
            "input_capacity": 2000000000, 
            "max_inv_size": 1e299, 
            "output_capacity": 2000000000, 
